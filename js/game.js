...
var levelListStored = [ // store the levels, later brought in with JSON
	{ num:1, name:"Starting Town", file:"levels/level1.json"},
	{ num:2, name:"Secondville", file:"levels/level2.json"},
];
...
var game = {
	...
	dropTruck: function(aTruck) {
		...
		console.log('On the truck drop to '+tilePos.x+', '+tilePos.y+' from '+aTruck.x+', '+aTruck.y+' distance '+tileDistance);
